...
public class PuppetConfigureNodeAction extends MonitoredAction {
    ...
    protected void doExecute(Context context) throws CloudManagerException {
        ...
        copyFiles(node, files);
        copyScripts(node, scripts);
        runScripts(node, scripts);
    }
     ...
     * @param scripts
     */
    protected void runScripts(Node node, List<Property> scripts) {

    }

    protected void copyScripts(Node node, List<Property> scripts) throws CloudManagerException {
        ...
        for(Property script : scripts) {
            if (logger.isDebugEnabled()) {
                logger.debug("Copying {} file to remote node", script.getName());
            }
            try {
     ...
     */
    protected void copyFiles(Node node, List<Property> files) throws CloudManagerException {
